    ...
    return (
        <div className=' h-screen w-full relative'>
            <div
                ...
                <AddMemberForm setIsFormOpen={setIsFormOpen} isFormOpen={isFormOpen} />

            </div>
            <CvaButton onClick={() => setIsFormOpen(!isFormOpen)} size={'medium'} intent='primary' plusIcon>Add Member</CvaButton>
        </div>
    )
}

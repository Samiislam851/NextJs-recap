    ...
    [ 'border', 'rounded'],
    {
        variants: {
            intent: {
                ...
                secondary: ['bg-gray-100', ' hover:bg-blue-500 hover:text-white', 'text-gray-700 font-medium']
            },
            size: {
...
const CvaButton = ({ className, type, children, intent, size, disabled = false, animate = false, plusIcon = false }: ButtonProps) => {
